...
(function() {
    ...
    const target_user_list = [
        ...
        '红旗文稿','千钧客','星炬网','军事博主','占豪','司马平邦','一个院长的思考','侠骨柔情的杨华','HW前HR','近卫T-34','电波震长空XYY','大漂亮傻事','子牛流沙','赵盛烨','喵斯拉大王二号机','马上谈',
        '明德先生','屠龙的胭脂井','沈逸','谦谦君子约翰逊','哈布斯堡长脸','牧星观海天','一碗荤豆花','卖萌的零食工','南海的浪涛2','李小龙Bruce_Lee','Blood旌旗','1002什么','华义凛','暴食症患者李舜生',
        '党人碑','PINK-MACARON-Fluttershy','lyman2003','持续低熵2023','别跟我抢荔枝这个昵称','杨升','霜叶','江宁婆婆','观察者网微丢视频','肯定是你疯了','幽靈船盛亞','卢克文','有轶见的Kris',
        '口口AX1','山高县2020','傻事傻事','国防时报','西江月如烟','王富棍','Eivor_Hydromancer','卖呓不卖呻','乌鸦校尉','肝帝董佳宁','崔紫剑','观视频工作室','提刀探花在缅北','台湾那点事儿','侠客岛',
        '赵立坚个人微博','孤烟暮蝉','沙盘上的战争','菜鸟耶夫斯基','高山CG','2049年的世界','V闪闪','赵脱俗','斯图卡98','空天砺剑','金灿荣教授','苏联余晖','炮霸707军情小站','没什么就是想换个昵称试试',
        '洗碗的席亚洲','萌虎鲸','水獭军一般兵','余亮-余不是大钊','一纸琉涟','正直的磊哥',
        '种花守护神','老曾阿牛','大象搬砖','司马3忌','一兔我饮酒醉','种花家的菌事兔','陶侃疫苗','沙姆雄狮_EL','奥卡姆剃刀','鹰眼军视','开水族馆的生物男','提刀探花阿青','汪海林','大包CG','萌音被限得不要不要的',
        '神嘛事儿','弓先声','一个让世界嫉妒的男人','张忆安-龙战于野','黑潮君','爱国熊猫老爷','鹅毛毛丹尼尔','马达MOTOR','高程CASS','JeffHoly姐夫的猴'
    ]
